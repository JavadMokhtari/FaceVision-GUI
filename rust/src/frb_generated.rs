...
fn wire__crate__api__ops__match_feature_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_ref_dir = <String>::sse_decode(&mut deserializer);
            let api_probe_dir = <String>::sse_decode(&mut deserializer);
            let api_output_dir = <String>::sse_decode(&mut deserializer);
            let api_recursive = <bool>::sse_decode(&mut deserializer);
            let api_is_quantized = <bool>::sse_decode(&mut deserializer);
            let api_feature_exts = <Vec<String>>::sse_decode(&mut deserializer);
            let api_verbose = <bool>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, String>((move || {
